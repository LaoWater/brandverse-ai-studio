        ...
        <div className="container mx-auto px-6">
          ...
          {selectedCompany && (
            <div className="flex justify-end mb-4">
              <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-card/80 backdrop-blur-sm border border-border/50 shadow-sm">
                {selectedCompany.logo_path ? (
                  <div className="w-10 h-10 rounded-lg bg-white dark:bg-white/90 flex items-center justify-center overflow-hidden">
                    <img
